...
import 'package:health2mama/Screen/find/consultant_list.dart';
...
class BookOnlineConsultation extends StatefulWidget {
  const BookOnlineConsultation({super.key});

  @override
  State<BookOnlineConsultation> createState() => _BookOnlineConsultationState();
}

class _BookOnlineConsultationState extends State<BookOnlineConsultation> {
  ...
  bool isButtonEnabled() {
    return servicesStage.isNotEmpty && specialistStages.any((stage) => stage.isSelected);
  }
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Padding(
              ...
              child: Text("Book Online Consultation",
                            ...
                            children: [
                              ...
                              TextFormField(
                                decoration: InputDecoration(
                                  ...
                                  hintText:
                                  "Select Services", // Set an empty hintText initially
                                ...
                                controller: TextEditingController(
                                    text:
                                    servicesStage), // Setting initial value
                                style: (displayType == 'desktop' ||
                                    displayType == 'tablet')
                                ...
                                onTap: () {
                                  setState(() {
                                    ...
                                    specialistStage = "";
                                    // isSpecialistDropdownTapped = false;
                                    // _loadDropdownData();
                                  });
                                },
                              ).animateOnPageLoad(
                              ...
                              TextFormField(
                                decoration: InputDecoration(
                                  ...
                                  hintText:
                                  "Select Specialisation", // Set an empty hintText initially
                                  hintStyle: (displayType == 'desktop' ||
                                      displayType == 'tablet')
                                      ? FTextStyle.loginFieldHintTextStyleTablet
                                      : FTextStyle.loginFieldHintTextStyle,
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: specialistStages.map((stage) {
                                      final isLastItem = specialistStages.indexOf(stage) == specialistStages.length - 1;
                              ...
                              Padding(
                                ...
                                child: ElevatedButton(
                                  onPressed: isButtonEnabled()
                                    ...
                                    List<String> selectedSpecializationsIds =
                                    specialistStages
                                    ...
                                    specialization.id)
                                        .toList();
                                    print(selectedSpecializationsIds);
                                    DataManager().services =
                                        selectedServices;
                                    DataManager().specialisations =
